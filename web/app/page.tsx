...
export default function Home() {
  ...
  const [groupMethod, setGroupMethod] = React.useState('all')
      ...
      <div className="h-screen w-screen flex flex-col">
        ...
        <div className="flex h-4/5 w-full">
          ...
          <div className="relative border-2 border-b-0 border-neutral-800 h-full w-2/4 flex flex-col">
            ...
            <TaskList viewTaskId={viewTaskId} setViewTaskId={setViewTaskId} completionFilter={completionFilter} priorityFilter={priorityFilter} tagsFilter={tagsFilter} groupMethod={groupMethod} />
          </div>
