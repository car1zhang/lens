  ...
  return (
    <div className="w-full h-full overflow-y-scroll flex flex-col">
      <ul>
        {taskList.map(task => (
          <li className={
            "border-b border-neutral-400 px-6 py-2 flex justify-between " + (viewTaskId == task['_id'] ? "bg-neutral-800 text-neutral-200" : "hover:bg-neutral-300")
            } key={task['_id']}>
            <div className="flex gap-2 ">
              ...
              <button className={
                ...
                } onClick={() => finish(task['_id'])}>X</button>
